...
with open('FB-HIGHLIGHTS.md', 'w+') as f:

	f.write('# Facebook Highlights')
	f.write("This page aggregates public and private posts I've made on Facebook that \
		got over {} likes.  Some posts are old and I might not necessarly agree with them anymore.\
		  All the same, here they are.".format(MIN_LIKES))
